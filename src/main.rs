...
fn main() {
    ...
    let (vec_p_first, vec_p_last) = vec_p.split_at(vec_p.len() - 10);
    let (vec_q_first, vec_q_last) = vec_q.split_at(vec_q.len() - 10);
    let (vec_r_first, vec_r_last) = vec_r.split_at(vec_r.len() - 10);
    let (vec_c_first, vec_c_last) = vec_c.split_at(vec_c.len() - 10);
    let (vec_u_first, vec_u_last) = vec_u.split_at(vec_u.len() - 10);
    let (vec_s_first, vec_s_last) = vec_s.split_at(vec_s.len() - 10);
